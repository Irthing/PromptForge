...
from promptforge.core.models import PromptTemplate, PromptVersion
from promptforge.core.storage import Storage
...
def test_save_and_get_template(storage: Storage, sample_template: PromptTemplate) -> None:
    ...
    retrieved = storage.get_template(sample_template.id)
...
def test_save_version(storage: Storage, sample_template: PromptTemplate) -> None:
    ...
    versions = storage.get_versions(sample_template.id)
